...
################################################################################
# Form generated from reading UI file 'pagesLBDvJm.ui'
##
...
class Ui_application_pages(object):
    def setupUi(self, application_pages):
        ...
        application_pages.resize(720, 485)
        self.page_1 = QWidget()
        ...
        self.label_3.setStyleSheet(u"font: 75 14pt \"Segoe UI\";\n"
        ...
        self.pushButton.setStyleSheet(u"QPushButton{\n"
                                      ...
                                      "}\n"
                                      "QPushButton:hover{\n"
                                      "	background-color: rgb(74, 204, 218);\n"
                                      "}\n"
                                      "QPushButton:pressed{\n"
                                      "	background-color: rgb(48, 50, 63);\n"
                                      "}")
    ...
    def retranslateUi(self, application_pages):
        application_pages.setWindowTitle(QCoreApplication.translate(
            "application_pages", u"StackedWidget", None))
        self.label_3.setText(QCoreApplication.translate(
            "application_pages", u"Ol\u00e1, ...", None))
        self.lineEdit.setPlaceholderText(QCoreApplication.translate(
            "application_pages", u"Escreva o seu nome", None))
        self.pushButton.setText(QCoreApplication.translate(
            "application_pages", u"Alterar Nome", None))
        self.label_2.setText(QCoreApplication.translate(
            "application_pages", u"P\u00e1gina 2", None))
        self.label.setText(QCoreApplication.translate(
            "application_pages", u"P\u00e1gina 3", None))
    # retranslateUi
